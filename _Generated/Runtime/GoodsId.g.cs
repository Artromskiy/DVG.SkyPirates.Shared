...
namespace DVG.SkyPirates.Shared.Ids
{
    ...
    partial struct GoodsId : IId, IEquatable<GoodsId>, IComparable<GoodsId>
    {
        ...
        public static readonly GoodsId None = new GoodsId("None");
        [IgnoreDataMember]
        ...
        public readonly bool Equals(GoodsId other) => _value == other._value;
        public readonly int CompareTo(GoodsId other) => Registry.Compare(this, other);
        ...
        public static bool operator ==(GoodsId a, GoodsId b) => a.Equals(b);
        public static bool operator !=(GoodsId a, GoodsId b) => !a.Equals(b);

        public static implicit operator GoodsId(string value) => new(value);
        public static implicit operator string(GoodsId id) => id.ToString();
        ...
        private static class Registry
        {
            ...
            public static int Compare(GoodsId lhs, GoodsId rhs)
            {
                if (lhs == rhs)
                    return 0;
