...
namespace DVG.SkyPirates.Shared.Ids
{
    ...
    partial struct GoodsId : IId, IEquatable<GoodsId>, IComparable<GoodsId>
    {
        ...
        public readonly bool Equals(GoodsId other) => (IsNone && other.IsNone) || string.Equals(Value, other.Value, StringComparison.Ordinal);
        public readonly int CompareTo(GoodsId other) => Equals(other) ? 0 : string.Compare(Value, other.Value, StringComparison.Ordinal);
