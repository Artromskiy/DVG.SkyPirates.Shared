...
namespace DVG.SkyPirates.Shared.Services.CommandExecutors
{
        ...
        ICommandExecutor<SpawnUnitCommand>
    {
        ...
        {
            _entityRegistryService.TryGet(cmd.Data.SquadId, out var squad);
            ...
            var unit = _unitFactory.Create((cmd.Data.UnitId, new(syncId, cmd.Data.SyncIdReserve, cmd.Data.RandomSeed)));
