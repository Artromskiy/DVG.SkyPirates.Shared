...
namespace DVG.SkyPirates.Shared.Services.CommandExecutors
{
        ...
        ICommandExecutor<Fixation>
    {
        ...
        public void Execute(Command<Fixation> cmd)
        {
            ExecuteOnEntity(cmd);
        }

        public void Execute(Command<Rotation> cmd)
        {
            ExecuteOnEntity(cmd);
        }

        public void Execute(Command<Position> cmd)
        {
            ExecuteOnEntity(cmd);
        }

        private void ExecuteOnEntity<T>(Command<T> cmd)
